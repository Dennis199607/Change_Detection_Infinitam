...
template<class TVoxel>
void ITMLib::ITMVisualisationEngine_CPU<TVoxel, ITMVoxelBlockHash>::updateDepthIntervals(ITMScene<TVoxel, ITMVoxelBlockHash>* activeScene, ITMScene<TVoxel, ITMVoxelBlockHash>* oldScene, const ORUtils::SE3Pose* pose, const ITMIntrinsics* intrinsics,
