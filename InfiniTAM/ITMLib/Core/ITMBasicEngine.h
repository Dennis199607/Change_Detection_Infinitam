...
namespace ITMLib
{
	...
	private:
		...
		ITMScene<TVoxel, TIndex>* activeScene;
		ITMScene<TVoxel, TIndex>* scene1;
		ITMScene<TVoxel, TIndex>* scene2;
	...
	public:
		...
		ITMScene<TVoxel, TIndex>* GetScene(void) { return activeScene; }
